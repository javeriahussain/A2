...
const styles = StyleSheet.create({
  ...
  shopButton: { marginTop: 10 },
  loginButton: { marginTop: 10 },
  listContainer: { padding: 10 },
  cartCard: { marginBottom: 10, elevation: 2 },
  cartItemContainer: { flexDirection: 'row', alignItems: 'center' },
  productImage: { width: 80, height: 80, borderRadius: 8 },
  productInfo: { flex: 1, marginLeft: 15 },
  productName: { fontSize: 16, fontWeight: 'bold', marginBottom: 5 },
  productPrice: { fontSize: 14, color: '#6200ee', marginBottom: 8 },
  ...
  checkoutButton: { paddingVertical: 6 },
});
